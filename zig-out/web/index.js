...
// include: /var/folders/yb/px9rmxx917b2_m_v2mylzdk00000gn/T/tmp0f62wq08.js
...
(() => {
  ...
  function loadPackage(metadata) {
    ...
    var PACKAGE_NAME = "/Users/karanjanthe/Projects/zigbeat/.zig-cache/o/9e223294cf20ce8502c8de9d6ecd3a8b/index.data";
    ...
    function runWithFS(Module) {
      ...
      function processPackageData(arrayBuffer) {
        ...
        Module["removeRunDependency"]("datafile_/Users/karanjanthe/Projects/zigbeat/.zig-cache/o/9e223294cf20ce8502c8de9d6ecd3a8b/index.data");
      }
      Module["addRunDependency"]("datafile_/Users/karanjanthe/Projects/zigbeat/.zig-cache/o/9e223294cf20ce8502c8de9d6ecd3a8b/index.data");
  ...
  loadPackage({
    "files": [ {
      "filename": "/assets/JetBrainsMono-Regular.ttf",
      "start": 0,
      "end": 270224
    }, {
      "filename": "/assets/songs.json",
      "start": 270224,
      "end": 777264
    } ],
    "remote_package_size": 777264
  });
})();

// end include: /var/folders/yb/px9rmxx917b2_m_v2mylzdk00000gn/T/tmp0f62wq08.js
// include: /var/folders/yb/px9rmxx917b2_m_v2mylzdk00000gn/T/tmpwvr79jl4.js
...
// end include: /var/folders/yb/px9rmxx917b2_m_v2mylzdk00000gn/T/tmpwvr79jl4.js
// include: /var/folders/yb/px9rmxx917b2_m_v2mylzdk00000gn/T/tmptxombc2g.js
...
// end include: /var/folders/yb/px9rmxx917b2_m_v2mylzdk00000gn/T/tmptxombc2g.js
...
var ASM_CONSTS = {
  ...
  138131: () => Module.canvas.width,
  138163: () => parseInt(Module.canvas.style.width),
  138211: () => {
  ...
  138574: () => window.innerWidth,
  138600: () => window.innerHeight,
  138627: () => {
    if (document.fullscreenElement) return 1;
  },
  138673: () => Module.canvas.width,
  138705: () => parseInt(Module.canvas.style.width),
  138753: () => {
    if (document.fullscreenElement) return 1;
  },
  138799: () => Module.canvas.width,
  138831: () => screen.width,
  138856: () => window.innerWidth,
  138882: () => window.innerHeight,
  138909: () => {
    if (document.fullscreenElement) return 1;
  },
  138955: () => Module.canvas.width,
  138987: () => screen.width,
  139012: () => {
    document.exitFullscreen();
  },
  ...
  139085: () => Module.canvas.width,
  139117: () => parseInt(Module.canvas.style.width),
  139165: () => {
    document.exitFullscreen();
  },
  139192: $0 => {
  ...
  139230: () => screen.width,
  139255: () => screen.height,
  139281: () => window.screenX,
  139308: () => window.screenY,
  139335: () => window.devicePixelRatio,
  139371: $0 => {
  ...
  139912: () => window.innerWidth,
  139938: () => window.innerHeight,
  139965: ($0, $1, $2, $3, $4) => {
  ...
  142433: () => (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined),
  142537: () => {
    try {
  ...
  145585: $0 => window.miniaudio.get_device_by_index($0).webaudio.sampleRate,
  145658: $0 => {
...
var emscriptenWebGLGetIndexed = (target, index, data, type) => {
  ...
  switch (type) {
   ...
   case 4:
    SAFE_HEAP_STORE(data, ret ? 1 : 0, 1);
    break;
...
var _emscripten_run_script_string = ptr => withBuiltinMalloc(() => {
      ...
      for (var joy = 0; joy < GLFW.lastGamepadState.length; ++joy) {
        ...
        if (gamepad) {
          ...
          for (var i = 0; i < gamepad.buttons.length; ++i) {
            SAFE_HEAP_STORE(data.buttons + i, gamepad.buttons[i].pressed, 1);
          }
...
var wasmImports = {
  ...
  /** @export */ glfwSetWindowAttrib: _glfwSetWindowAttrib,
